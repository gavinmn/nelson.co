...
<Tool
  ...
  image="raycast.svg"
  name="Raycast"
  description="I only recenlty added Raycast to my workflow but I have been blown away by what is possible with it so far. Between intergrations and custom scripts, everything I need is suddenly a few kestrokes away."
/>
...
<Tool
  ...
  name="Instapaper"
  description="Anything I want to read online first gets sent to Instapaper so it can be read when I have time, in a distraction free environement, with a digital highlighter."
/>
