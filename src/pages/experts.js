  ...
  >
    ...
    <Wrapper size="small">
      ...
      <p>
        ...
        summer of 2018 at wikiHow. The project focused on designing an entirely
        new suite of pages (responsive web) to house credentials for our 500+
        expert verifiers.
      </p>
      ...
      <p>
        ...
        designs had to account for an engineering team with low bandwidth. To
        ease use of engineering resources, I had to repurpose many components
        from across wikiHow and stick to pre built wikiHow technologies to build
        this new custom page.
      </p>
    ...
    <Wrapper size="small">
      ...
      <p>
        ...
        editable by using the same backend editing that the rest of our site
        uses.
      </p>
      <HalfWidthImage>
        <Image
      ...
      <p>
        ...
        custom engineering from the developers. A tradeoff of using these
        sections however was the limited text formatting that came with it.
      </p>
      <br></br>
      <p>
      ...
      <p>
        ...
        sections mentioned above. My final solution included a toggle so that
        the experts team could switch this right hand column between Education
        and Achievements, depending upon the expert.{" "}
      </p>
    </Wrapper>
    ...
    <Wrapper size="small">
      <p>
        Splitting the right hand section into either education or achievements
        was a data driven design decision - users reported that the sections
        that made the page most trustworthy to them depended upon the category
        of the expert. For example, when reading about a Legal Expert, users
        reported being interested in seeing where the expert went to law school,
        while when reading about a Guitar Expert, their achievements were
        reported to be more applicable.
      </p>
      ...
      <p>
        ...
        Given wikiHow's design language and system, I will often jump quickly to
        a high fidelity stage and test and iterate from there.
      </p>
      <br></br>
      <p>
        In addition to plenty of stakeholder constraints mentioned above,
        wikiHow generally likes to move very quickly and often doesn't have much
    ...
    <Wrapper size="small">
      ...
      <p>
        ...
        quick moment to validate design decisions with various company members
