  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          Access global contrast settings in Properties panel → Render
          Properties tab → Color Management → Look dropdown. I find bumping up
          the contrast to <code>Medium High Contrast</code> is a good starting
          point.
        </li>
        <li>
          Hover over a corner of an editor section and your cursor will display
          as a +. Click and drag to split the section into two and select the
      ...
      <ul>
        ...
        <li>
          <code>tab</code> toggles between Object mode and Edit mode. Object
          mode is used for manipulating whole meshes/objects, while edit mode
          will allow manipulation of individual vertices, edges, and faces.
          <ul>
            <li>
        ...
        <li>
          ...
          <ul>
            <li>
              Holding <code>control</code> while doing this will lock the field
              to whole numbers (or easy decimals).
            </li>
            <li>
      ...
      <ul>
        <li>
          <code>g</code> for grab - move selected objects or points within the
          3D space.
        </li>
        <li>
          <code>r</code> for rotate - rotate selected objects within the 3D
          space.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <code>shift + axis key</code> locks a previously selected transform
          key transform to the other two axes. Ex. <code>g → shift + z</code>{" "}
          will allow moving the selected object on only the x and y axes.
        </li>
        <li>
          Double pressing an axis key locks the axis of transform to the objects
          normal rather than the world axis. Ex. <code>s → x → x</code> will
          scale the selected object on <em>the object's</em> x axis, rather than
          the world's x axis.
        </li>
      </ul>
      ...
      <p>
        Pie menus are circular UI selection menus that appear on a keypress at
        the cursor. Moving the cursor away from the menu's origin will select
        the designated menu item. Getting used to using these and forming muscle
      ...
      <ul>
        ...
        <li>
          <code>z</code> invokes the viewport shading pie menu. Use this to
          change your viewport shading between wireframe, solid, material
      ...
      <ul>
        <li>
          <code>right click</code> an object and select{" "}
          <code>shade smooth</code> to achieve smooth shading on a curved
          surface.
          <ul>
            <li>
              Prevent smoothing over edges above a chosen angle by toggling{" "}
              <code>Auto Smooth</code> in Properties panel → Normals tab →
              Normals → Auto Smooth. This is helpful when you are working with a
              shape that needs both curves and hard edges.
            </li>
          </ul>
        </li>
        <li>
          When modeling, try to stick to creating and manipulating objects that
          are made of Quads (4 vertices per face) rather than Tris (3 vertices
          per face) or Ngons ( &gt; 4 vertices per face). This will make working
          with modifier properties easier.
          <ul>
            <li>
              The default sphere mesh is made of Tris. To create a sphere
        ...
        <li>
          ...
          cut. This is a <em>very</em> helpful tool to use when you are trying
          to manipulate meshes and need some extra vertices to work with.
        </li>
      </ul>
      ...
      <p>
        ...
        Properties panel. Below are the general modifiers that I find most
        helpful for basic modeling. Experiment by applying them to default
        meshes to learn the ins and outs of each modifier.
        <br></br>
        <br></br>
      </p>

      <Caption>
        Note - clicking apply after selecting a modifier is a destructive
        action. Often you do not need to apply modifiers and can work
        non-destructively.
      </Caption>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>
              Bevel Limit Method - a helpful tool to limit what edges are
              beveled. <code>Angle</code> is useful to limit beveling to only
              sharp edges (defined by a degree input). <code>Weight</code> will
              let you bevel only selected edges by weight. Weight is assigned to
              edges in edit mode in the transform panel under &quot;Edge
              Data.&quot;
            </li>
          </ul>
        </li>
        <li>
          ...
          selected object. Great for creating curved surfaces from angled
          meshes.
          <ul>
            <li>
        ...
        <li>
          ...
          meshes and screw things up when used in combo with a Subdivision
          modifier.
        </li>
      </ul>
      ...
      <p>
        ...
        with the <code>Principled BDSF</code> shader that is added when you
