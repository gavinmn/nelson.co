    ...
    <Fade>
      <PortfolioContainer>
        ...
        <SmallWrapper>
          <h3>Project</h3>
          <p>
            I worked with Chalk for approximately three months during the spring
            and summer of 2019 to design the core user experience for their
            upcoming iOS application.
          </p>
          ...
          <p>
            ...
            complicated, proving difficult for new users to learn and tricky for
            power users to control. This was something that Chalk found in their
            initial user testing, and I was able to confirm as I tried to
            understand the app.
          </p>
          ...
          <p>
            ...
            communicate via voice for rapid fire group conversation.<br></br>
            <br></br>In addition to these three modes, there is an{" "}
            <i>anchoring</i> setting that allows the user to lock the app in
            listen mode for a set period of time, even while in the background.
            <br></br>
            <br></br>My final solution reworked the interaction model to feature
            a primary action button in the bottom left corner of the screen that
          ...
          <p>
            When a new mode is entered, a contextual button would appear next to
            the action button to let the user control settings specific to the
            current mode such as anchoring time in listen mode and muting in
            talk mode.
          </p>
        </SmallWrapper>
        ...
        <SmallWrapper>
          <p>
            Other data driven details of the reworked UI/UX include rings around
            the group avatars to indicate other users’ active modes, colored
            message bubbles to further provide context on what mode the user is
            currently in, as well as a redesigned header to better comply with
        ...
        <SmallWrapper>
          ...
          <p>
            ...
            type mindset and through discussions with Chalk, narrowed the ideas
            down to a more practical set.
          </p>
        </SmallWrapper>
        ...
        <SmallWrapper>
          ...
          <p>
            ...
            users to adopt against how well it would fit in Chalk’s development
            timeline. From my user testing and the teams best estimates, the
            action button model was show to be the winner.
          </p>

          <br></br>
          <h3>High Fidelity Details</h3>
          <p>
            From here I began developing some high fidelity mockups and working
            on details such as the icons for the modes.
          </p>
        </SmallWrapper>
        ...
        <SmallWrapper>
          <p>
            Through a handful of iterations these details came together to form
            the final product discussed in detail above.
          </p>
        </SmallWrapper>
      </PortfolioContainer>
    </Fade>
